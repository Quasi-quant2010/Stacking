...
if __name__ == '__main__':
    ...
    # 3. stacking by Logistic Regression(LR) - (1-Level)
    ...
    skf = list(StratifiedKFold(y_train, n_folds=6))
    train_feature = []
    train_label = []
    for i, (sub_train, sub_test) in enumerate(skf):
        ...
        meta_feature = clf.predict_proba(transformated_features_sub_test)[:,1]
    ...
    meta_feature = clf.predict_proba(transformated_test_features)[:,1]
