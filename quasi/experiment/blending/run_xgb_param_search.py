...
def xgb_grid_search(stack_setting_,
    ...
    gs = param_search.GridSearch(XgboostModel, exp, param_keys, param_vals,
                                 cv_folder = stack_setting_['2-Level']['xgb']['cv']['folder'],
                                 cv_out = stack_setting_['2-Level']['xgb']['cv']['cv_out'], 
                                 cv_pred_out = stack_setting_['2-Level']['xgb']['cv']['cv_pred_out'], 
                                 refit_pred_out = stack_setting_['2-Level']['xgb']['cv']['refit_pred_out'])
    best_param, best_score = gs.search_by_cv(validation_metrics = stack_setting_['2-Level']['xgb']['cv']['metrics'])
    ...
    get_xgb_feature_importance_plot(best_param_ = best_param,
                                    experiment_ = exp,
                                    png_folder = stack_setting_['2-Level']['xgb']['graph']['folder'],
                                    png_fname = stack_setting_['2-Level']['xgb']['graph']['name'])
