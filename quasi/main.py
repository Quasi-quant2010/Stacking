...
if __name__ == "__main__":
    ...
    stack_setting = {'0-Level':{'folder':'input',
                     ...
                     'setting':{'folder':'stack_setting',
                                'name':'stack_setting_one_hot_encoding.json'},
                     'result':None
                     }

    # 1. 0-Level
    # 1.1 feature filtering
    feat_filter.main_transform(stack_setting_ = stack_setting)
    ...
    upper_param = {'model_type':[GradientBoostingClassifier],
                   ...
                   'max_features': [5, 10], #[5, 10], #max_features must be in (0, n_features]
    ...
    param = {'model_type':[XGBClassifier], 
             ...
             'nthread':[6],
             'n_estimators':[50, 100, 500, 1000], #[50, 100, 500, 1000]
             'seed':[9438]}
    ...
    stack_setting['result'] = "accuracy=%1.5e, precision=%1.5e, recall=%1.5e, f=%1.5e" % (accuracy, precision, recall, f)
